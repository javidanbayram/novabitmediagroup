...
export const metadata: Metadata = {
  title: 'Our Brands — Novabit Media Group',
  description:
    'Explore the digital media brands of Novabit Media Group — including Novabit.az, our flagship technology publication, and Soma.az, coming soon.',
};
        ...
        <section className="pt-36 pb-20 relative overflow-hidden">
          ...
          <div className="container-xl relative z-10 text-center">
            ...
            <p className="text-white/55 text-xl max-w-3xl mx-auto leading-relaxed">
              A growing portfolio of innovative digital media platforms, each designed to serve specific audiences with trusted content, exceptional journalism, and modern digital experiences.
            </p>
          </div>
        </section>
